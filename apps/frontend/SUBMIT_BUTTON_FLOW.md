...
- **Endpoint**: `POST https://test-instance.inplsoftwares.online/api/tenant/{tenant_id}/invoices`
...
- **Endpoint**: `DELETE https://test-instance.inplsoftwares.online/api/tenant/{tenant_id}/invoices/{saved_invoice_id}`
